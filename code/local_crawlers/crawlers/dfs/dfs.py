...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        ...
        if not os.path.exists(os.path.join(os.getcwd(), "crawlers","dfs","logs")):
            os.mkdir(os.path.join(os.getcwd(), "crawlers","dfs","logs"))

        if not os.path.exists(os.path.join(os.getcwd(), "crawlers","dfs","logs", str(log_path_all_sites))):
            os.mkdir(os.path.join(os.getcwd(), "crawlers","dfs","logs", str(log_path_all_sites)))    
