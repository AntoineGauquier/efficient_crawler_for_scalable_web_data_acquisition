...
class BFSCrawler(GenericLocalCrawler):
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        ...
        log_path = os.path.join(os.getcwd(), "local_crawlers/bfs/logs", str(log_path_all_sites), str(site_name))
        ...
        bfs_crawler = BFSCrawler(db_path=db_path, 
            table_name=table_name, 
            log_path=log_path, 
            starting_url=starting_url, 
            use_url_classifier=use_url_classifier, 
